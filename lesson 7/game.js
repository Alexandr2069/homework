...
let game = {
    ...
    render() {
        this.renderer.render(this.snake.body, this.food.getFoodCoordinates(), this.snake.body.length - 1); // -1 от длины тела змейки чтобы вести счет с 0
    },
...
window.onload = function () {
    game.init({speed: 3, winLength: 45});
};
