...
let renderer = {
    ...
    render(snakePointArray, foodPoint, totalScore) { // передаем счет которым является длина змейки - 1
        this.score.innerText = `Счёт: ${totalScore}`; // в див передаем текст со счетом
